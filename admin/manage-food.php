...
<div class="main-content">
    <div class="wrapper">
        ...
        <a href="<?php echo SITEURL; ?>admin/verify_import_food.php" class="btn-primary">Import Food</a>
        <a href="<?php echo SITEURL; ?>admin/view_foods.php" class="btn-primary">View Foods</a>
